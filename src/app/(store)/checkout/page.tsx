...
export default function CheckoutPage() {
  ...
  if (loading) {
    return <div className="container py-10">در حال بارگذاری...</div>
  }

  if (!cart) {
    return <div className="container py-10">سبد خرید خالی است.</div>
  }
        ...
        <div>
          <Card>
            ...
            <CardContent>
              ...
              <Button className="w-full mt-6">ادامه</Button>
            </CardContent>
          </Card>
        </div>
      </div>
